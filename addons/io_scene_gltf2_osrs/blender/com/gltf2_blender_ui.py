...
class NODE_OT_GLTF_SETTINGS2(bpy.types.Operator):
...
class SCENE_PT_gltf2_animation(bpy.types.Panel):
    ...
    @classmethod
    def poll(self, context):
        return bpy.context.preferences.addons['io_scene_gltf2_osrs'].preferences.animation_ui is True
...
def register():
    bpy.utils.register_class(NODE_OT_GLTF_SETTINGS2)
...
def unregister():
    bpy.utils.unregister_class(NODE_OT_GLTF_SETTINGS2)
